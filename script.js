...
function main() {
  ...
  class Table {
    ...
    createPercentageChangeCell() {
      ...
      if (this.percentageValues.length === 1) {
        ...
        if (
          this.fromValues[this.counter] !== this.fromValues[this.counter - 1]
        ) {
  ...
  changeAllValuesBtn.addEventListener("click", () => {
    ...
    if (table1.fromValues.length > 0) {
      ...
      form2AllInputsArray[2].value =
        table1.percentageValues[table1.counter - 1];
      ...
      form2AllInputsArray[5].value =
        table2.percentageValues[table2.counter - 1];
      ...
      form2AllInputsArray[8].value =
        table3.percentageValues[table3.counter - 1];
      ...
      form2AllInputsArray[11].value =
        table4.percentageValues[table4.counter - 1];
    }
